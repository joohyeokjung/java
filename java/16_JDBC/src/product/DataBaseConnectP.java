...
public class DataBaseConnectP {
	// 싱글톤 방식
	// 데이터 베이스를 스태틱으로 한번 올려놓고 계속 사용하는 방식
	private static DataBaseConnectP dbc = new DataBaseConnectP();
	...
	public static DataBaseConnectP getInstance() {
		return dbc;
	}
