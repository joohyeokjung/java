...
public class DataTypeEx {
	...
	public static void main(String[] args) {
		System.out.println("기본 데이터 타입 (Primative Daa Type");
		...
		char ch = 'A'; // 2byte의 크기문자 => 반드시 홑 따옴표를 사용한다!!!!
		
		long longNum = 1235166142L; // 리터럴 표기법 => 숫자의 정확한 타입의 표기를 위함 => 8byte
		float floatNum = 3.142342423234f; // 리터럴 표기법 => 숫자의 정확한 타입의 표기를 위함 => 4byte
